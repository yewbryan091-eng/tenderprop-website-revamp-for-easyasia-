    ...
    <div ref={mapRef} className={`wm-map wm-map--${finish} ${className}`.trim()} aria-hidden="true">
      ...
      <div className="wm-compass" aria-hidden="true">
        <svg viewBox="0 0 56 64" width="56" height="64">
          ...
          {/* slender needle, diamond pivot, two 45deg survey strokes */}
          <path className="wm-compass-line" d="M28 15 V52" />
          <path className="wm-compass-line" d="M18.5 42.5 L24 37 M37.5 42.5 L32 37" />
          <path className="wm-compass-diamond" d="M28 30.4 L31.6 36 L28 41.6 L24.4 36 Z" />
