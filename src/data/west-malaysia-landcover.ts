...
export const RIVERS: { key: string; d: string; note: string }[] = [
  {
    key: "pahang",
    note: "Sungai Pahang — the peninsula's longest river, Titiwangsa to the South China Sea.",
    d: line([
      [101.85, 4.05],
      [102.2, 3.85],
      [102.6, 3.6],
  ...
  {
    key: "perak",
    note: "Sungai Perak — north to south down the Kinta valley, out through the Straits.",
    d: line([
      [101.45, 5.75],
      [101.15, 5.3],
      [101.0, 4.85],
  ...
  {
    key: "kelantan",
    note: "Sungai Kelantan — the interior highlands down to the Kota Bharu delta.",
    d: line([
      [101.85, 5.15],
      [102.05, 5.55],
      [102.15, 5.95],
  ...
  {
    key: "muar",
    note: "Sungai Muar — Negeri Sembilan through Johor to the Straits.",
    d: line([
      [102.35, 2.85],
      [102.55, 2.55],
      [102.6, 2.25],
