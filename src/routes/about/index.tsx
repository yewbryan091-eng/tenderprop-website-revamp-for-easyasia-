...
function Page() {
  return (
    <PageShell
      ...
      lede="TenderProp is run by a licensed Malaysian real estate agency. Your e-tender deposit is held by the agency as stakeholder and refunded in full if no sale proceeds — this page exists to prove that, not to tell a company story."
      frames={[
