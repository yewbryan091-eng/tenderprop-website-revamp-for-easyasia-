...
function Page() {
  return (
    <PageShell
      ...
      frames={[
        { title: "Next auction — date + countdown", what: "The auction date is this page's heartbeat, same pattern as the e-tender cycle." },
        ...
        { title: "Auction listings", what: "Reuses the listing card component with auction date + time.", blocked: "real records — live site still shows 'test' data and RM- prices" },
