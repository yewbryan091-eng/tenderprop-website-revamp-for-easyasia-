...
| Owner Auction detail — Tender Information left panel | `src/components/tender/AuctionSinaranDetail.tsx`, scoped Owner Auction dossier rules in `src/styles/tender-detail.css` | **Codex** | 14 Aug | ACTIVE: replacing the copied E-Tender period with an auction-specific event/registration schedule; right panel and E-Tender page remain untouched. |
