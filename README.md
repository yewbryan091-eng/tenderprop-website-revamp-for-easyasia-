...
|---|---|---|
| 0a | **[`COLLABORATOR-BRIEF.md`](./COLLABORATOR-BRIEF.md)** | **Start here if you are a person or a model joining to review or advise.** Who Bryan is, the family agency, the two platforms, the compliance rules, how he works, and how to give feedback he can use |
| 0b | **[`TENDERPROP-BRIEF.md`](./TENDERPROP-BRIEF.md)** | The product itself, A–Z in one self-contained file — business model, the rules that keep getting broken, data model, what is built, what is still open |
